...
class IndividualWorkPlanController extends Controller
{
    ...
    public function actionReject($IndividualWorkPlanId){
        $model = $this->findModel($IndividualWorkPlanId);
        ...
        if($model->save()){
            //TODO: Send Email Here Notifying Appraisee
            Yii::$app->session->setFlash('success', "WorkPlan Rejected Successfully"); 
        }
    ...
    public function actionApprove($IndividualWorkPlanId){
        $model = $this->findModel($IndividualWorkPlanId);
        ...
        if($model->save()){
            //TODO: Send Email Here Notifying Appraisee
            Yii::$app->session->setFlash('success', "WorkPlan Approved Successfully"); 
        }
    ...
    public function actionSubmitted()
    {
        ...
        $dataProvider->query->andwhere(" IndividualWorkPlan.ImmediateSupervisor = '$identity->no'");
