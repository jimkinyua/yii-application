...
/**
 * AreasOfImprovementSearch represents the model behind the search form of `common\models\AreasOfImprovement`.
 */
class AreasOfImprovementSearch extends AreasOfImprovement
{
    /**
     * {@inheritdoc}
     */
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            'AreaImprovementId' => $this->AreaImprovementId,
