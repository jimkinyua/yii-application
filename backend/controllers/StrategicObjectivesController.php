...
use common\models\StrategicObjectivesSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * StrategicObjectivesController implements the CRUD actions for StrategicObjectives model.
 */
class StrategicObjectivesController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $searchModel = new StrategicObjectivesSearch();
