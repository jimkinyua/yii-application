...
/**
 * KeyResultAreaAttachementsSearch represents the model behind the search form of `common\models\StrategicObjectives`.
 */
class KeyResultAreaAttachementsSearch extends StrategicObjectives
{
    /**
     * {@inheritdoc}
     */
