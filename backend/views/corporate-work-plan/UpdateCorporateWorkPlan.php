            ...
            <div class="card-header">
                <div class="card-tools">
                    <div class="headert" style="float: right;">
                        <?= Html::a('Submit To Head of Departments',
                         ['/corporate-work-plan/submit',
                          'CorporatetWorkPlanId'=> $model->CorporateWorkPlanId],
        ...
        <div class="card card-outline card-success">
            <div class="card-header"> 
                <div class="card-tools" style="float: left;">
                    <?= Html::button('Add Strategic Objectives', ['value' => Url::to(['corporate-strategic-objectives/create', 'WorkPlanId'=>$model->CorporateWorkPlanId]),
                     'title' => 'Add Strategic Objectives', 'class' => 'btn btn-primary  btn-flat border-primary showModalButton']); ?>
                </div>
            </div>
            <div class="card-body">
                        ...
                        <?php foreach($model->corporateStrategicObjectives as $CorporateStrategicObjective): ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <?php   $url = Url::to(['/corporate-strategic-objectives/delete', 
                                                'id' => $CorporateStrategicObjective->CorporateObjectiveId,
                                                ]);
                                    ?>
                                    <?= Html::a('Remove', $url, [
