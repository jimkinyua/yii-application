        ...
        <?php //endif; ?>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="/individual-work-plan/" class="nav-link nav-new_evaluator tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Open  Work Plans</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="/individual-work-plan/submitted" class="nav-link nav-evaluator_list tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Submitted Work Plans</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="/individual-work-plan/approved" class="nav-link nav-evaluator_list tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Approved Work Plans</p>
                </a>
              </li>

              <li class="nav-item">
                <a href="/individual-work-plan/rejected" class="nav-link nav-evaluator_list tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Rejected Work Plans</p>
                </a>
              </li>
