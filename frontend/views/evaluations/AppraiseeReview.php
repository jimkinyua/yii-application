                                                                    ...
                                                                    foreach($model->keyResultAreas as $tsk){
                                                                            if($tsk->IndividualObjectiveId == $obj->IndividualObjectiveId){
                                                                                    ...
                                                                                    foreach($files as $file){
                                                                                        // if(strlen($file)){
                                                                                        //     $evidence_path= 'C:\inetpub\wwwroot\NewLookAppraisal\yii-application\frontend';
                                                                                        //     $resourcelink = $evidence_path.'/uploads/'.$file;
                                                                                        //     if(is_file($resourcelink))
                                                                                        //     $size = floor(filesize($resourcelink)/1024);
                                                                                        ...
                                                                                        //         $content = Html::img($resourcelink,['alt'=>"Pic",'width'=>'50','height'=>'50','style'=>'align:center;']);
                                                                                        ...
                                                                                        //                     <a class="mailbox-attachment-name" href="'.$resourcelink.'">
                                                                                        //                     <i class="fa fa-paperclip"></i>'
                                                                                        //                                         .$file.'
                                                                                        //                     </a>
                                                                                        //                     <span class="mailbox-attachment-size">
                                                                                        //                         &nbsp;Size '.$size.' Mb
                                                                                        //                         <a class="btn btn-default btn-xs pull-right" href="/site/dl?file='.$file.'">
                                                                                        //                             <i class="fa fa-cloud-download"></i>
                                                                                        //                         </a>
                                                                                        //                         <!--<a class="btn btn-default btn-xs pull-left" href="'.$resourcelink.'">
                                                                                                                ...
                                                                                                                <table class="table table-bordered">
                                                                                                                    ...
                                                                                                                    <tbody>
                                                                                                                        <tr>
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                <th class="bg-green">Weighted Score ((Agreed Score *'.$tsk->WorkPlanWeight.') /5)</th><td></td><td>'.$weighted_score.'</td>
                                                                                                                            </tr>
                                                                                                                    </tbody>
                                                                                                                </table>
                                                                                                            </div>
                        ...
                        <table class="table">
                            ...
                            if(count($model->perfomanceSkills)){
                                ...
                                if(isset($perf->SupervisorRating) && $perf->SelfRating>0 && $perf_counter >0 ){
                                    ...
                                    $scoreperf = ceil(targetWeighted($weighted,10));
                                }
